...
def test_project_script_asset_frame_minimal_loop() -> None:
    ...
    frame_list_response = client.get(f"/api/v1/projects/{project_id}/frames")
...
def test_project_script_crud() -> None:
    ...
    get_empty_response = client.get(f"/api/v1/projects/{project_id}/script")
    ...
    get_updated_response = client.get(f"/api/v1/projects/{project_id}/script")
    assert get_updated_response.status_code == 200
    assert get_updated_response.json()["content"] == "第二版剧本"

    delete_response = client.delete(f"/api/v1/projects/{project_id}/script")
    assert delete_response.status_code == 204

    get_deleted_response = client.get(f"/api/v1/projects/{project_id}/script")
...
def test_project_asset_crud() -> None:
    ...
    empty_list_response = client.get(f"/api/v1/projects/{project_id}/assets")
    ...
    deleted_list_response = client.get(f"/api/v1/projects/{project_id}/assets")
